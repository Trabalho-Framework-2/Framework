🔹 Backend Developer
Responsável por:
•	Criar a API com Node.js + Express
•	Implementar autenticação com JWT
•	Criar rotas de cadastro, login, listagem e criação de cursos
...
•	Integrar com a API usando axios ou fetch
...
•	Testar funcionalidades do sistema (cadastro, login, listagem)
